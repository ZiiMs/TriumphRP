            ...
            while(GetGameTimer() < timer + 2500) do 
                ...
                if (GetVehiclePedIsIn(GetPlayerPed(-1),false) ~= 0 ) then
                    if (GetPedInVehicleSeat(GetVehiclePedIsIn(GetPlayerPed(-1),false), -1) == GetPlayerPed(-1)) then
                        local y = 1.320 + safeZoneOffset
                        local x = 0.670 - safeZoneOffset
                        if level.current == 0 then
                            drawTxt(x, y, 1.0,1.0,0.4, "Voice: Normal", 255,255,255,255)
                        elseif level.current == 1 then
                            drawTxt(x, y, 1.0,1.0,0.4, "Voice: Yell", 255,255,255,255)
                        elseif level.current == 2 then
                            drawTxt(x, y, 1.0,1.0,0.4, "Voice: Whisper", 255,255,255,255)
                        end
                    else
